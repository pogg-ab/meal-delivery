...
export class AddPayoutChildandAggregate1762160968960
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'aggregated_payouts',
      new TableIndex({ columnNames: ['payout_batch_id'] }),
    );
    await queryRunner.createIndex(
      'aggregated_payouts',
      new TableIndex({ columnNames: ['restaurant_id'] }),
    );
    ...
    await queryRunner.createIndex(
      'payout_children',
      new TableIndex({ columnNames: ['parent_aggregate_id'] }),
    );
    await queryRunner.createIndex(
      'payout_children',
